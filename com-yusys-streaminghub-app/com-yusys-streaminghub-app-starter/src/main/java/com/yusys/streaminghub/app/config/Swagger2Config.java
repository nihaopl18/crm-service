...
//                .apis(RequestHandlerSelectors.basePackage("com.yusys.streaminghub.app"))
    ...
    private ApiInfo apiInfo() {
         return new ApiInfoBuilder()
                 .title("流中心-app-api")
                 .description("流中心业务应用示例工程")
                 .contact(new Contact("cj","https://github.com/carocean","zhaoxb1@yusys.com.cn"))
                 .version("1.0.0")
                 .build();
     }
    /**
