...
@Entity
public class CrmFCissCgBaseVO implements Serializable{
  ...
  private String initialCout;
	...
	/**
	 * 客群类型 : 01 高级查询客群 02 基础客群
	 */
    @ApiModelProperty(value = "客群类型 : 01 高级查询客群 02 基础客群")
  ...
  private String updateUser;
     ...
     * 客戶漲幅數
     */
    @ApiModelProperty(value = "客戶漲幅數")
  private int floatCustomer;
    /**
     * 规则
     */
    @ApiModelProperty(value = "规则")
  private CrmFCgCustomerPreparation crmFCgCustomerPreparation;
  ...
  public void setUpdateUser(String updateUser) {
    ...
    public int getFloatCustomer() {
        return floatCustomer;
    }

    public void setFloatCustomer(int floatCustomer) {
        this.floatCustomer = floatCustomer;
    }

    public CrmFCgCustomerPreparation getCrmFCgCustomerPreparation() {
        return crmFCgCustomerPreparation;
    }

    public void setCrmFCgCustomerPreparation(CrmFCgCustomerPreparation crmFCgCustomerPreparation) {
        this.crmFCgCustomerPreparation = crmFCgCustomerPreparation;
    }
}
