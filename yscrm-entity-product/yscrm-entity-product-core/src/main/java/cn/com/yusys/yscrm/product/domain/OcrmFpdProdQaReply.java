 ...
 * @类名称: OcrmFpdProdQaReply
 * @类描述: #数据实体类
 * @功能描述: 
 * @创建人: yantianyi
 * @创建时间: 2019-02-11 17:12:41
 * @修改备注: 
 * @修改记录: 修改时间    修改人员    修改原因
 * -------------------------------------------------------------
 * @version 1.0.0
 ...
 */
@Entity
@Table(name = "OCRM_F_PD_PROD_QA_REPLY")
public class OcrmFpdProdQaReply extends BaseDomain implements Serializable{
    ...
    public boolean equals(Object that) {
        ...
        OcrmFpdProdQaReply other = (OcrmFpdProdQaReply) that;
