 ...
 * generated in the cn.com.yusys.yscrm.custservice.util package. 
...
public class ObjectFactory {
    ...
    private final static QName _SRVReqHead_QNAME = new QName("http://www.whrcbank.com/service/bd/R17602003045R", "SRVReqHead");
    private final static QName _SRVResHead_QNAME = new QName("http://www.whrcbank.com/service/bd/R17602003045R", "SRVResHead");
    private final static QName _SysHeader_QNAME = new QName("http://www.whrcbank.com/common/header/in", "sysHeader");
    private final static QName _Request_QNAME = new QName("http://www.whrcbank.com/service/bd/R17602003045R", "request");
    private final static QName _Response_QNAME = new QName("http://www.whrcbank.com/service/bd/R17602003045R", "response");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: cn.com.yusys.yscrm.custservice.util
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "http://www.whrcbank.com/service/bd/R17602003045R", name = "SRVReqHead")
     ...
     */
    @XmlElementDecl(namespace = "http://www.whrcbank.com/service/bd/R17602003045R", name = "SRVResHead")
     ...
     */
    @XmlElementDecl(namespace = "http://www.whrcbank.com/service/bd/R17602003045R", name = "request")
     ...
     */
    @XmlElementDecl(namespace = "http://www.whrcbank.com/service/bd/R17602003045R", name = "response")
