...
public class AcrmFciPerCust extends BaseDomain implements Serializable{
	...
	/** ECIF客户标识 **/
	@Column(name = "ECIF_CUST_ID", unique = false, nullable = true, length = 17)
	private String ecifCustId;
	
	/** 客户名称 **/
	@Column(name = "CUST_NAME", unique = false, nullable = true, length = 60)
//	@ColumnConfig(description = "客户名称", lookup = "", key = true)
	...
	/** 客户称谓代码 **/
	@Column(name = "TITLE_CD", unique = false, nullable = true, length = 2)
	...
	/** 民族 **/
	@Column(name = "NATION", unique = false, nullable = true, length = 2)
	private String nation;
	
	/** 出生日期 **/
	@Column(name = "BIRTH_DT", unique = false, nullable = true, length = 8)
