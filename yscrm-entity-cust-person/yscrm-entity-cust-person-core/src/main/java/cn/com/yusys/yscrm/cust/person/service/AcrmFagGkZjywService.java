 ...
 */
@Service
public class AcrmFagGkZjywService extends CommonService {
    @Autowired
    private AcrmFagGkZjywMapper acrmFagGkZjywMapper;

    @Override
    protected CommonMapper<?> getMapper() {
        return acrmFagGkZjywMapper;
    }
	...
	public List<Map<Object, String>> queryZjywByCustId(QueryModel model, String custId) {
		...
		List<Map<Object, String>>  list = acrmFagGkZjywMapper.queryZjywByCustId(paramMap);
