 ...
 * @类名称: OcrmFciPreRelatInfo
 * @类描述: #数据实体类
 * @功能描述: 
 * @创建人: Administrator
 * @创建时间: 2019-03-01 10:16:46
 * @修改备注: 
 * @修改记录: 修改时间    修改人员    修改原因
 * -------------------------------------------------------------
 * @version 1.0.0
...
public class OcrmFciPreRelatInfo extends BaseDomain implements Serializable{
 ...
 **/
	...
	/** 示范户认定时间
 **/
	@Column(name = "DEM_HOU_DET_TIME", unique = false, nullable = true, length = 10)
 ...
 **/
	...
	/** 是否新型农业经营主体
 **/
	@Column(name = "WHE_NEW_AGR_MAN_SUB", unique = false, nullable = true, length = 2)
	private String wheNewAgrManSub;
	
	/** 主体类型
 **/
	@Column(name = "PRI_TYPE", unique = false, nullable = true, length = 10)
 ...
 **/
	...
	/** 保险金额
 **/
	@Column(name = "AMO_OF_INS", unique = false, nullable = true, length = 22)
	private java.math.BigDecimal amoOfIns;
	
	/** 保险费
 **/
	@Column(name = "INSURANCE", unique = false, nullable = true, length = 22)
	private java.math.BigDecimal insurance;
	
	/** 保险险种
 **/
	@Column(name = "INS_TYPE", unique = false, nullable = true, length = 10)
 ...
 **/
	...
	/** 扶贫客户类型
 **/
	@Column(name = "POV_ALL_CUS_TYPE", unique = false, nullable = true, length = 10)
	private String povAllCusType;
	
	/** 扶贫项目
 **/
	@Column(name = "POV_ALL_PRO", unique = false, nullable = true, length = 200)
	private String povAllPro;
	
	/** 项目所在地
 **/
	@Column(name = "PRO_LOC", unique = false, nullable = true, length = 200)
 ...
 **/
	 ...
	 * @param amoOfIns
	 */
	public void setAmoOfIns(java.math.BigDecimal amoOfIns) {
		this.amoOfIns = amoOfIns;
	}
	
    /**
     * @return AmoOfIns
     */	
	public java.math.BigDecimal getAmoOfIns() {
    ...
    public boolean equals(Object that) {
        ...
        OcrmFciPreRelatInfo other = (OcrmFciPreRelatInfo) that;
