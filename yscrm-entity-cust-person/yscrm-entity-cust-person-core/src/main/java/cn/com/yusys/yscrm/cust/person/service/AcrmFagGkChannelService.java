 ...
 */
@Service
public class AcrmFagGkChannelService extends CommonService {
    @Autowired
    private AcrmFagGkChannelMapper acrmFagGkChannelMapper;

    @Override
    protected CommonMapper<?> getMapper() {
        return acrmFagGkChannelMapper;
    }
	...
	public List<Map<Object, String>> queryChannelByCustId(QueryModel model, String custId) {
		...
		List<Map<Object, String>>  list = acrmFagGkChannelMapper.queryChannelByCustId(paramMap);
