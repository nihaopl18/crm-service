 ...
 * generated in the cn.com.yusys.yscrm.cust.person.util package. 
...
public class ObjectFactory {
    ...
    private final static QName _Request_QNAME = new QName("http://www.whrcbank.com/service/bd/R17601003044R", "request");
    private final static QName _Response_QNAME = new QName("http://www.whrcbank.com/service/bd/R17601003044R", "response");
    private final static QName _SRVReqHead_QNAME = new QName("http://www.whrcbank.com/service/hd/crm", "SRVReqHead");
    private final static QName _SRVResHead_QNAME = new QName("http://www.whrcbank.com/service/hd/crm", "SRVResHead");
    private final static QName _SysHeader_QNAME = new QName("http://www.whrcbank.com/common/header/in", "sysHeader");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: cn.com.yusys.yscrm.cust.person.util
     * 
     */
    ...
    /**
     * Create an instance of {@link ProdListType }
     * 
     */
    public ProdListType createProdListType() {
        return new ProdListType();
    }

    /**
     * Create an instance of {@link SuitProdType }
     * 
     */
    public SuitProdType createSuitProdType() {
        return new SuitProdType();
    }

    /**
     * Create an instance of {@link SuitProdListType }
     * 
     */
    public SuitProdListType createSuitProdListType() {
        return new SuitProdListType();
    }
     ...
     */
    @XmlElementDecl(namespace = "http://www.whrcbank.com/service/bd/R17601003044R", name = "request")
     ...
     */
    @XmlElementDecl(namespace = "http://www.whrcbank.com/service/bd/R17601003044R", name = "response")
     ...
     */
    @XmlElementDecl(namespace = "http://www.whrcbank.com/service/hd/crm", name = "SRVReqHead")
     ...
     */
    @XmlElementDecl(namespace = "http://www.whrcbank.com/service/hd/crm", name = "SRVResHead")
