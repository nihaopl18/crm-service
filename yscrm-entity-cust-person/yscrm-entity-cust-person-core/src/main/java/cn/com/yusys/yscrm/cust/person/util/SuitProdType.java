...
/**
 * <p>suitProdType complex type�� Java �ࡣ
 * 
 * <p>����ģʽƬ��ָ�������ڴ����е�Ԥ�����ݡ�
 * 
 * <pre>
 * &lt;complexType name="suitProdType"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "suitProdType", propOrder = {
    "prdNo",
    "prdName"
})
public class SuitProdType {
	...
	public String toString() {
		return "SuitProdType [prdNo=" + prdNo + ", prdName=" + prdName + "]";
	}
