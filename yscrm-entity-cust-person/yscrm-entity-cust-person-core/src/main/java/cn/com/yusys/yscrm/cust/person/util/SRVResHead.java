...
@XmlType(name = "SRVResHead", namespace = "http://www.whrcbank.com/service/bd/R17601003044R", propOrder = {
    "transCode",
    "userNm",
    "authPw",
    "tlrNo",
...
public class SRVResHead {
	...
	public String toString() {
		return "SRVResHead [transCode=" + transCode + ", userNm=" + userNm + ", authPw=" + authPw + ", tlrNo=" + tlrNo
				+ ", tlrPwd=" + tlrPwd + ", brchNo=" + brchNo + ", fileHMac=" + fileHMac + ", fileName=" + fileName
				+ ", fileSendType=" + fileSendType + ", svrDt=" + svrDt + ", svrTm=" + svrTm + ", svrSeqNo=" + svrSeqNo
				+ ", rowNum=" + rowNum + "]";
	}
