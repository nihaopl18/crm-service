...
import cn.com.yusys.yscrm.cust.person.domain.TxLog;
import cn.com.yusys.yscrm.cust.person.repository.mapper.LogMapperss;
import cn.com.yusys.yscrm.cust.person.util.SrvReqBody;
import cn.com.yusys.yscrm.cust.person.util.SrvResBody;
import cn.com.yusys.yscrm.cust.person.util.SysMsgHeader;
...
@Service
public class LogServicess extends CommonService {
	@Autowired
	private   LogMapperss mapper;
	@Override
...
//		SpringBeanAutowiringSupport.processInjectionBasedOnCurrentContext(this);
	 ...
	 * @throws ParseException
	 */
	public  int addLogCore(Map<String,Object> map )
			throws ParseException {
		cn.com.yusys.yscrm.cust.person.interfaces.SysMsgHeader sysqHeader = (cn.com.yusys.yscrm.cust.person.interfaces.SysMsgHeader)map.get("reqhead");
		cn.com.yusys.yscrm.cust.person.interfaces.SrvReqBody srvqBody = (cn.com.yusys.yscrm.cust.person.interfaces.SrvReqBody)map.get("reqbody");
		cn.com.yusys.yscrm.cust.person.interfaces.SysMsgHeader srsbh = (cn.com.yusys.yscrm.cust.person.interfaces.SysMsgHeader)map.get("rsphead");
		cn.com.yusys.yscrm.cust.person.interfaces.SrvResBody srsb = (cn.com.yusys.yscrm.cust.person.interfaces.SrvResBody)map.get("rspbody");
		String msg = (String)map.get("msg");
		TxLog txLog = new TxLog();
		long id = new Random().nextLong();
		txLog.setTxLogId(id);
