 ...
 */
@Service
public class AcrmFagGkSaveService extends CommonService {
    @Autowired
    private AcrmFagGkSaveMapper acrmFagGkSaveMapper;

    @Override
    protected CommonMapper<?> getMapper() {
        return acrmFagGkSaveMapper;
    }
	...
	public List<Map<Object, String>> queryDepositByCustId(QueryModel model, String custId) {
		...
		List<Map<Object, String>>  list = acrmFagGkSaveMapper.queryDepositByCustId(paramMap);
