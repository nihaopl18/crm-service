 ...
 * @创建时间：2019-01-24
 */
public interface OcrmFMkActivityMapper extends CommonMapper<OcrmFMkActivityInfo> {
	/**
	* @方法名称: actiListQuery
	* @方法描述: 营销活动信息查询
	* @参数与返回说明: 
	...
	* @算法描述:
	**/
	public int actiCustInsert(OcrmFMkActiCustInfo record);
	/**
	* @方法名称: actiFileInsert
	* @方法描述: 关联附件新增
	* @参数与返回说明: 
	* @算法描述:
	**/
	public int actiFileInsert(OcrmFMkActiAttachRelInfo record);
	/**
	* @方法名称: actiProdInsert
	* @方法描述: 关联产品新增
	* @参数与返回说明: 
	* @算法描述:
	**/
	public int actiProdInsert(OcrmFMkActiProductInfo record);
	/**
	* @方法名称: actiDel
	* @方法描述: 营销产品删除
	* @参数与返回说明: 
	...
	* @算法描述:
	**/
	public int actiTransfer(OcrmFMkActiTransApplyInfo record);
	/**
	* @方法名称: actiSameName
	* @方法描述: 营销活动名称验重
	* @参数与返回说明: 
