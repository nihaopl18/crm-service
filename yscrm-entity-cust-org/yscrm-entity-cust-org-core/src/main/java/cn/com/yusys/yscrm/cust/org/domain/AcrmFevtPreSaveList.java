...
public class AcrmFevtPreSaveList extends BaseDomain implements Serializable{
 ...
 **/
	...
	/** ETL日期
 **/
	@Column(name = "ETL_DT", unique = false, nullable = true, length = 30)
 ...
 **/
	@Transient
	@Column(name = "TRANS_DT", unique = false, nullable = true, length = 8)
 ...
 **/
	...
	public void setEtlDt(String etlDt) {
		this.etlDt = etlDt == null ? null : etlDt.trim();
	}
    ...
    public boolean equals(Object that) {
        ...
        AcrmFevtPreSaveList other = (AcrmFevtPreSaveList) that;
		return (this.getEventNo() == null ? other.getEventNo() == null : this.getEventNo().equals(other.getEventNo()))
        	&& (this.getEtlDt() == null ? other.getEtlDt() == null : this.getEtlDt().equals(other.getEtlDt()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getEtlDt() == null) ? 0 : getEtlDt().hashCode());
