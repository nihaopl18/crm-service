 ...
 * @类名称: OcrmFciOrgProjectInfoMapper
 * @类描述: #Dao类
 * @功能描述: 项目信息
 * @创建人: 15104
 ...
 */
public interface OcrmFciOrgProjectInfoMapper extends CommonMapper<OcrmFciOrgProjectInfo> {
	/**
	* @方法名称: querylist
	* @方法描述: 查询
	* @算法描述:
	...
	* @算法描述:
	 */
	int deleteByComProId(QueryModel param);
}