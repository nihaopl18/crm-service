 ...
 */
@Entity
@Table(name = "PMA_F_COM_DEP_DISTRIBUTE")
public class PmaFcomDepDistributeInfo extends BaseDomain implements Serializable {
    ...
    /** 分配类型 **/
    @Column(name = "allot_type", unique = false, nullable = true, length = 32)
    private String allotType   ;

    /** 客户经理编号 **/
    @Column(name = "manager_id", unique = false, nullable = true, length = 32)
