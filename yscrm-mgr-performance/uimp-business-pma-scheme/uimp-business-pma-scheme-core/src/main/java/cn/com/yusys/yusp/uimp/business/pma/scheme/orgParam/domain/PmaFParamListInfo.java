 ...
 * @类名称: PmaFParamListInfo
 * @类描述: PMA_F_PARAM_LIST_INFO数据实体类
 * @功能描述: 
 * @创建人: asus
 ...
 */
@Entity
@Table(name = "PMA_F_PARAM_LIST_INFO")
public class PmaFParamListInfo extends BaseDomain implements Serializable{
