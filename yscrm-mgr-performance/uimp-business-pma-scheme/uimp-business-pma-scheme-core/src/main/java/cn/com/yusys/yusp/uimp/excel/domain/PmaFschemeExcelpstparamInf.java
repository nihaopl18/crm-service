 ...
 * @类名称: PmaFschemeExcelpstparamInf
 * @类描述: PMA_F_SCHEME_EXCELPSTPARAM_INF考核方案报表岗位参数信息表 数据实体类
 * @功能描述: 
 * @创建人: lixt1
 ...
 */
@Entity
@Table(name = "PMA_F_SCHEME_EXCELPSTPARAM_INF")
public class PmaFschemeExcelpstparamInf extends BaseDomain implements Serializable{
	...
	/** 岗位参数编号 **/
	@Column(name = "POST_PARAM_ID", unique = false, nullable = false, length = 30)
	private String postParamId;
	 ...
	 * @param postParamId
	 */
	public void setPostParamId(String postParamId) {
		this.postParamId = postParamId == null ? null : postParamId.trim();
	}
	
    /**
     * @return PostParamId
     */	
	public String getPostParamId() {
		return this.postParamId;
	}
