 ...
 * @类名称: PmaFschemeExceldutyInf
 * @类描述: PMA_F_SCHEME_EXCELDUTY_INF考核方案报表岗位信息表 数据实体类
 * @功能描述: 
 * @创建人: lixt1
 ...
 */
@Entity
@Table(name = "PMA_F_SCHEME_EXCELDUTY_INF")
public class PmaFschemeExceldutyInf extends BaseDomain implements Serializable{
	...
	/** 岗位编号 **/
	@Column(name = "DUTY_ID", unique = false, nullable = true, length = 32)
