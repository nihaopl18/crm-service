 ...
 * @类名称: PmaFSchemeIndexSplit
 * @类描述: PMA_F_SCHEME_INDEX_SPLIT数据实体类
 * @功能描述: 
 * @创建人: Administrator
 ...
 */
@Entity
@Table(name = "PMA_F_SCHEME_INDEX_SPLIT")
public class PmaFSchemeIndexSplit extends BaseDomain implements Serializable{
