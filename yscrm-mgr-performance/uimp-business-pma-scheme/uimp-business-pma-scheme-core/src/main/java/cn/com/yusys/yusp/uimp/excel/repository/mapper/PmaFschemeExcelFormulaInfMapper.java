 ...
 * @类名称: PmaFschemeExcelFormulaInfMapper
 * @类描述: #考核方案报表公式信息表 Dao类
 * @功能描述: 
 * @创建人: lixt1
 ...
 */
public interface PmaFschemeExcelFormulaInfMapper extends CommonMapper<PmaFschemeExcelFormulaInf> {
     ...
     * @算法描述:
     */
	Integer batchInsert(@Param("dataList") List<PmaFschemeExcelFormulaInf> dataList);
     ...
     * @函数描述:根据模板ID、数据日期、考核对象编号，删除公式信息表(备份表)数据
     * @参数与返回说明:
     * @算法描述:
     */
