 ...
 * @类名称: PmaFschemeExcelpstparamInfMapper
 * @类描述: #考核方案报表岗位参数信息表 Dao类
 * @功能描述: 
 * @创建人: lixt1
 ...
 */
public interface PmaFschemeExcelpstparamInfMapper extends CommonMapper<PmaFschemeExcelpstparamInf> {
     ...
     * @算法描述:
     */
	Integer batchInsert(@Param("dataList") List<PmaFschemeExcelpstparamInf> dataList);
	...
	/**
     * @方法名称: getPreviewInfo
     * @方法描述: 根据模板ID、考核对象编号，查询-岗位参数单元格预览数据
     * @参数与返回说明: 
     * @算法描述:
     */
	List<Map<String, Object>> getPreviewInfo(@Param("templateId") String templateId, @Param("evlObjId") String evlObjId);
	
	/**
     * @函数名称:deleteBackupTableDataByTemplateIdAndEtlDateAndEvlObjId
     * @函数描述:根据模板ID、数据日期、考核对象编号，删除岗位参数信息表(备份表)数据
     * @参数与返回说明:
     * @算法描述:
     */
