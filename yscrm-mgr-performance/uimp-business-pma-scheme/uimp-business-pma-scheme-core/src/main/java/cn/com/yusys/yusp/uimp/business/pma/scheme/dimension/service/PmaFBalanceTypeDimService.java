 ...
 */
@Service
public class PmaFBalanceTypeDimService extends CommonService {
    @Autowired
    private PmaFIndexBalInfoMapper pmaFIndexBalInfoMapper;

    @Override
    protected CommonMapper<?> getMapper() {
        return pmaFIndexBalInfoMapper;
    }
