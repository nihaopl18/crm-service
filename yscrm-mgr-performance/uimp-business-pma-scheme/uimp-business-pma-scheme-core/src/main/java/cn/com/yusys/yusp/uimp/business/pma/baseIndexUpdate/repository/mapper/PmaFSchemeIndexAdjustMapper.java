 ...
 * @类名称: PmaFSchemeIndexAdjustMapper
 * @类描述: #Dao类
 * @功能描述: 
 * @创建人: Administrator
 ...
 */
public interface PmaFSchemeIndexAdjustMapper extends CommonMapper<PmaFSchemeIndexAdjust> {
	
	String queryAdjustId(QueryModel model);
}