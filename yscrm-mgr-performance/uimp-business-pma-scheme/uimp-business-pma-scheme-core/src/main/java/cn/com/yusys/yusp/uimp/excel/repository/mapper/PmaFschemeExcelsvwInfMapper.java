 ...
 * @类名称: PmaFschemeExcelsvwInfMapper
 * @类描述: #考核方案报表得分/计价/权重信息表 Dao类
 * @功能描述: 
 * @创建人: lixt1
 ...
 */
public interface PmaFschemeExcelsvwInfMapper extends CommonMapper<PmaFschemeExcelsvwInf> {
     ...
     * @算法描述:
     */
	Integer batchInsert(@Param("dataList") List<PmaFschemeExcelsvwInf> dataList);
     ...
     * @函数描述:根据模板ID、数据日期、考核对象编号，删除得分/计价/权重信息表(备份表)数据
     * @参数与返回说明:
     * @算法描述:
     */
