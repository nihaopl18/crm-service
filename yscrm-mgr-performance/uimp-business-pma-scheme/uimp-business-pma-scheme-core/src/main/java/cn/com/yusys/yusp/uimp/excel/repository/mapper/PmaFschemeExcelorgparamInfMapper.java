 ...
 * @类名称: PmaFschemeExcelorgparamInfMapper
 * @类描述: #考核方案报表机构参数信息表 Dao类
 * @功能描述: 
 * @创建人: lixt1
 ...
 */
public interface PmaFschemeExcelorgparamInfMapper extends CommonMapper<PmaFschemeExcelorgparamInf> {
     ...
     * @算法描述:
     */
	Integer batchInsert(@Param("dataList") List<PmaFschemeExcelorgparamInf> dataList);
     ...
     * @算法描述:
     */
	List<Map<String, Object>> getPreviewInfo(@Param("templateId") String templateId,@Param("evlObjType") String evlObjType, 
			@Param("evlObjId") String evlObjId);
	
	/**
     * @函数名称:deleteBackupTableDataByTemplateIdAndEtlDateAndEvlObjId
     * @函数描述:根据模板ID、数据日期、考核对象编号，删除机构参数信息表(备份表)数据
     * @参数与返回说明:
     * @算法描述:
     */
