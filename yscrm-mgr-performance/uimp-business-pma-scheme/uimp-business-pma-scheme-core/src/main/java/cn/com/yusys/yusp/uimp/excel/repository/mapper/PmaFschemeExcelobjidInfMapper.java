 ...
 * @类名称: PmaFschemeExcelobjidInfMapper
 * @类描述: #考核方案报表考核对象编号信息表 Dao类
 * @功能描述: 
 * @创建人: lixt1
 ...
 */
public interface PmaFschemeExcelobjidInfMapper extends CommonMapper<PmaFschemeExcelobjidInf> {
     ...
     * @算法描述:
     */
	Integer batchInsert(@Param("dataList") List<PmaFschemeExcelobjidInf> dataList);
     ...
     * @函数描述:根据模板ID、数据日期、考核对象编号，删除考核对象编号信息表(备份表)数据
     * @参数与返回说明:
     * @算法描述:
     */
