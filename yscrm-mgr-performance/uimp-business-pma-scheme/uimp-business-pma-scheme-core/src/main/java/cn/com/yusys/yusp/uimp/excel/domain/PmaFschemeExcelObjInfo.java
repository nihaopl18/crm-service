 ...
 * @类名称: PmaFschemeExcelObjInfo
 * @类描述: PMA_F_SCHEME_EXCELOBJ_INF考核方案报表考核对象信息表 数据实体类
 * @功能描述: 
 * @创建人: lixt1
 ...
 */
@Entity
@Table(name = "PMA_F_SCHEME_EXCELOBJ_INF")
public class PmaFschemeExcelObjInfo extends BaseDomain implements Serializable{
	...
	/** 考核对象名称 **/
	@Column(name = "EVL_OBJ_NAME", unique = false, nullable = false, length = 100)
	...
	public void setEvlObjName(String evlObjName) {
		this.evlObjName = evlObjName == null ? null : evlObjName.trim();
	}
