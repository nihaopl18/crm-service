 ...
 * @类名称: AcrmFciOrgCustInfo
 * @类描述: #数据实体类
 * @功能描述: 
 * @创建人: hyx
 * @创建时间: 2019-03-29 15:37:00
 * @修改备注: 
 * @修改记录: 修改时间    修改人员    修改原因
 * -------------------------------------------------------------
 * @version 1.0.0
 ...
 */
@Entity
@Table(name = "ACRM_F_CI_ORG_CUST_INFO")
public class AcrmFciOrgCustInfo extends BaseDomain implements Serializable{
	...
	/** 主营范围 **/
	@Column(name = "COM_MAIN_OPT_SCP", unique = false, nullable = true, length = 400)
	private String comMainOptScp;
	
	/** 兼营范围 **/
	@Column(name = "COM_PART_OPT_SCP", unique = false, nullable = true, length = 400)
    ...
    public boolean equals(Object that) {
        ...
        AcrmFciOrgCustInfo other = (AcrmFciOrgCustInfo) that;
