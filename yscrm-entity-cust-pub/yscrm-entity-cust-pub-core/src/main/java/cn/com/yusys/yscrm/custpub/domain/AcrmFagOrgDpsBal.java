 ...
 * @类名称: AcrmFagOrgDpsBal
 * @类描述: #数据实体类
 * @功能描述: 
 * @创建人: hyx
 * @创建时间: 2019-01-15 11:52:35
 * @修改备注: 
 * @修改记录: 修改时间    修改人员    修改原因
 * -------------------------------------------------------------
 * @version 1.0.0
 ...
 */
@Entity
@Table(name = "ACRM_F_AG_ORG_DPS_BAL")
public class AcrmFagOrgDpsBal extends BaseDomain implements Serializable{
	...
	/** 子帐号标识 **/
	@Column(name = "SUBACCT_NO", unique = false, nullable = true, length = 32)
	...
	/** 账户名称 **/
	@Column(name = "ACCT_NAME", unique = false, nullable = true, length = 200)
	...
	/** 定活标志 **/
	@Column(name = "TERM_FLG", unique = false, nullable = true, length = 20)
	...
	/** 钞汇标志 **/
	@Column(name = "FCY_CASH_FLG", unique = false, nullable = true, length = 20)
	...
	/** 所属机构 **/
	@Column(name = "OWN_BRCH_NO", unique = false, nullable = true, length = 30)
	private String ownBrchNo;
	
	/** 科目编号 **/
	@Column(name = "SUBJECT_CD", unique = false, nullable = true, length = 20)
	...
	/** 通知存款标志 **/
	@Column(name = "TERM_TYPE", unique = false, nullable = true, length = 1)
	private String termType;
	
	/** 转存标志 **/
	@Column(name = "ROLL_FLAG", unique = false, nullable = true, length = 1)
	private String rollFlag;
	
	/** 利多宝标志 **/
	@Column(name = "LDB_FLAG", unique = false, nullable = true, length = 1)
	private String ldbFlag;
	
	/** 利享存标志 **/
	@Column(name = "LXC_FLAG", unique = false, nullable = true, length = 1)
    ...
    public boolean equals(Object that) {
        ...
        AcrmFagOrgDpsBal other = (AcrmFagOrgDpsBal) that;
