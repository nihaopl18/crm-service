 ...
 * @类名称: AcrmFciPerAdmitInfo
 * @类描述: #数据实体类
 * @功能描述: 
 * @创建人: hyx
 * @创建时间: 2019-03-29 15:35:35
 * @修改备注: 
 * @修改记录: 修改时间    修改人员    修改原因
 * -------------------------------------------------------------
 * @version 1.0.0
...
public class AcrmFciPerAdmitInfo extends BaseDomain implements Serializable{
	...
	/** 信贷信用评级 **/
	@Column(name = "CREDIT_GRADE", unique = false, nullable = true, length = 10)
	...
	/** 是否有效户 **/
	@Column(name = "EFFECT_FLG", unique = false, nullable = true, length = 20)
    ...
    public boolean equals(Object that) {
        ...
        AcrmFciPerAdmitInfo other = (AcrmFciPerAdmitInfo) that;
