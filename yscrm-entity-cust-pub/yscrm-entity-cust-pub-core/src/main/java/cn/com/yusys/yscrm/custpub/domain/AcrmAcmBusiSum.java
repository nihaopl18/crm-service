 ...
 */
@Entity
@Table(name = "ACRM_A_CM_BUSI_SUM")
public class AcrmAcmBusiSum extends BaseDomain implements Serializable{
	...
	/** 管理有效客户数新增 **/
	@Column(name = "NEW_EFF_NUM", unique = false, nullable = true, length = 10)
	private long newEffNum;
	...
	@Column(name = "CUST_NUM_GRADE_LV8", unique = false, nullable = true, length = 10)
	private long custNumGradeLv8;
	 ...
	 * @param newEffNum
	 */
	public void setNewEffNum(long newEffNum) {
		this.newEffNum = newEffNum;
	}
	
    /**
     * @return NewEffNum
     */	
	public long getNewEffNum() {
		return this.newEffNum;
	}
	...
	/**
	 * @param custNumGradeLv8
	 */
	public void setCustNumGradeLv8(long custNumGradeLv8) {
		this.custNumGradeLv8 = custNumGradeLv8;
	}
	
    /**
     * @return CustNumGradeLv8
     */	
	public long getCustNumGradeLv8() {
		return this.custNumGradeLv8;
	}
    ...
    public boolean equals(Object that) {
        ...
        AcrmAcmBusiSum other = (AcrmAcmBusiSum) that;
