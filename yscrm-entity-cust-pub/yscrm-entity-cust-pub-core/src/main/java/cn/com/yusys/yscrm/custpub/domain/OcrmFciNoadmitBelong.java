 ...
 * @类名称: OcrmFciNoadmitBelong
 * @类描述: #数据实体类
 * @功能描述: 
 * @创建人: hyx
 * @创建时间: 2019-03-29 15:43:00
 * @修改备注: 
 * @修改记录: 修改时间    修改人员    修改原因
 * -------------------------------------------------------------
 * @version 1.0.0
...
public class OcrmFciNoadmitBelong extends BaseDomain implements Serializable{
    ...
    public boolean equals(Object that) {
        ...
        OcrmFciNoadmitBelong other = (OcrmFciNoadmitBelong) that;
		return (this.getBelongId() == null ? other.getBelongId() == null : this.getBelongId().equals(other.getBelongId()))
