...
public class OcrmFciPreGradeApplyInfo extends BaseDomain implements Serializable{
	...
	@Column(name = "APP_HOURS", unique = false, nullable = true, length = 7)
	...
	/** 当期服务等级 **/
	@Column(name = "CUR_SER_LEVEL", unique = false, nullable = true, length = 2)
	private String curSerLevel;
	
	/** 申请服务等级 **/
	@Column(name = "APP_SER_LEVEL", unique = false, nullable = true, length = 2)
