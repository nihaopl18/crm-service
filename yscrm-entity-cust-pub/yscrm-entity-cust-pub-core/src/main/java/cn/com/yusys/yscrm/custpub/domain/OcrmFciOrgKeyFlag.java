 ...
 * @类名称: OcrmFciOrgKeyFlag
 * @类描述: #数据实体类
 * @功能描述: 
 * @创建人: hyx
 * @创建时间: 2019-01-15 11:57:29
 * @修改备注: 
 * @修改记录: 修改时间    修改人员    修改原因
 * -------------------------------------------------------------
 * @version 1.0.0
 ...
 */
@Entity
@Table(name = "OCRM_F_CI_ORG_KEY_FLAG")
public class OcrmFciOrgKeyFlag extends BaseDomain implements Serializable{
	...
	/** 法人 **/
	@Column(name = "CORP_ORG_CODE", unique = false, nullable = false, length = 20)
    ...
    public boolean equals(Object that) {
        ...
        OcrmFciOrgKeyFlag other = (OcrmFciOrgKeyFlag) that;
