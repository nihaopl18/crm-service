 ...
 */
@Entity
@Table(name = "LOY_QY_VIRT_STOCK_TEMP")
public class LoyQyVirtStockTemp extends BaseDomain implements Serializable{
    ...
    public boolean equals(Object that) {
        ...
        LoyQyVirtStockTemp other = (LoyQyVirtStockTemp) that;
