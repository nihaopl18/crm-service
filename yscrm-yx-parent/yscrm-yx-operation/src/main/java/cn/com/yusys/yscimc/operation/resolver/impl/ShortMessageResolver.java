 ...
 */
@Component
public class ShortMessageResolver extends AbstractChannelResolver {
...
//        DateTimeFormatter df = DateTimeFormatter.ofPattern("HH:mm:ss");
        ...
        ShortMessageInfoVo shortMessageInfoVo = new ShortMessageInfoVo();
...
//                LocalDateTime beginTime = LocalDateTime.parse(cimpCmNodesPresentation.getFormOperationVal(),df);
                shortMessageInfoVo.setBeginTime(cimpCmNodesPresentation.getFormOperationVal());
            }
...
//                LocalDateTime endTime = LocalDateTime.parse(cimpCmNodesPresentation.getFormOperationVal(),df);
                shortMessageInfoVo.setEndTime(cimpCmNodesPresentation.getFormOperationVal());
            }
            if (cimpCmNodesPresentation.getFormOperationFiled().equals("sendType")){
                shortMessageInfoVo.setSendType(cimpCmNodesPresentation.getFormOperationVal());
            }
        }
        shortMessageInfoVo.setAssemblyId(ComponentTypeEnum.SHORT_MESSAGE.getComponentType());
        shortMessageInfoVo.setNodeId(nodeId);
        channelInfoVoList.add(shortMessageInfoVo);
