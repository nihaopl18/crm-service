 ...
 */
@Component
public class CustomerImportResolver extends AbstractGenericCustomerResolver {
    ...
    public CustomerImportResolver(CimpCCustgroupCustService customerGroupService) {
    ...
    public String getType() {
        return ComponentTypeEnum.CONSUMER_IMPORT.getComponentType();
    }
}
