...
import cn.com.yusys.yscimc.operation.domain.entity.CmicAppAsseSignImgEntity;
...
public class CmicAppAssembleSignUpVo {
    ...
    private List<CmicAppAsseSignImgEntity> list;

    public List<CmicAppAsseSignImgEntity> getList() {
        return list;
    }

    public void setList(List<CmicAppAsseSignImgEntity> list) {
        this.list = list;
    }
