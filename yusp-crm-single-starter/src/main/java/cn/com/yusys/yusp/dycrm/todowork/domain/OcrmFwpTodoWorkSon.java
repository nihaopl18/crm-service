 ...
 */
@Entity
@Table(name = "OCRM_F_WP_TODO_WORK_SON")
public class OcrmFwpTodoWorkSon extends BaseDomain implements Serializable {
	...
	/** 周期性事项ID **/
	@Column(name = "NOTICE_ID", unique = false, nullable = true, length = 40)
	...
	/** 事项执行人 **/
	@Column(name = "FINISHER", unique = false, nullable = true, length = 30)
	...
	/** 关联客户 **/
	@Column(name = "RELATION_CUST", unique = false, nullable = true, length = 800)
	private String relationCust;

	/** 跟进类型 **/
	@Column(name = "CONTACT_TYPE", unique = false, nullable = true, length = 4)
	private String contactType;

	/** 跟进目的 **/
	@Column(name = "CONTACT_GOAL", unique = false, nullable = true, length = 4)
	...
	public String getContactGoal() { return contactGoal; }

	public void setContactGoal(String contactGoal) { this.contactGoal = contactGoal == null ? null : contactGoal.trim(); }
	...
	public boolean equals(Object that) {
		...
		OcrmFwpTodoWorkSon other = (OcrmFwpTodoWorkSon) that;
	...
	public String toString() {
		...
		sb.append(", finisherName=").append(finisher);
		...
		sb.append(", relationCustName=").append(relationCust);
