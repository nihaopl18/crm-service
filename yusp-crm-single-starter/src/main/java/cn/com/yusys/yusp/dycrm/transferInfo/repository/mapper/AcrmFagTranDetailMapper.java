 ...
 */
public interface AcrmFagTranDetailMapper extends CommonMapper<AcrmFagTranDetail> {
	...
	List<TransferInfoAG> excelMonth(QueryModel model);

	List<TransferInfoAG> excelAll(QueryModel model);
}